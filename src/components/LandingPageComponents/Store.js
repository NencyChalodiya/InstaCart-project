    ...
    <div className="pl-5 pr-5">
      <div className="w-full mt-8 mb-8">
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <button className="mt-8 font-sans text-base font-normal leading-6 text-green-600 bg-transparent border-none cursor-pointer font-bodyLarge1 font-wght-600 font-opsz-8 focus:outline-none">Show all</button>
        </div>
      </div>
    </div>
  );
